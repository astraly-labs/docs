...
The oracle address can be found [here](./development.mdx).
...
You can finally deploy the contract. The addresses used for the constructor are the oracle contract address and the summary stats contract address. You can find the oracle address [here](./development.mdx). You can find the summary stats address [here](./advanced/overview.mdx).
