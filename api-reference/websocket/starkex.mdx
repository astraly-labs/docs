...
We have already cooked a nice ratatui for you to test the endpoint, you can find it [here]().
...
You can also use `wscat` or any other websocket client to subscribe to the Pragma websocket endpoint.